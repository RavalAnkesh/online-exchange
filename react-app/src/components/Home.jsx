...
function Home() {
    ...
    useEffect(() => {
        ...
        const likedProductsUrl = API_URL + '/liked-products';
        const data = { userId: localStorage.getItem('userId') };
        axios.post(likedProductsUrl, data)
            .then((res) => {
                if (res.data.products) {
                    setLikedProducts(res.data.products);
                }
    ...
    const handleClick = () => {
        const searchUrl = API_URL + '/search?search=' + search + '&loc=' + localStorage.getItem('userLoc');
        axios.get(searchUrl)
            .then((res) => {
                setCProducts(res.data.products);
                setIsSearch(true);
